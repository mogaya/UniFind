...
const FoundItems = () => {
    const { foundItems, categories } = usePage<PageProps>().props;
    ...
    const filteredItems = foundItems.filter((item) => {
        const matchesSearch =
            ...
            item.where_found.toLowerCase().includes(searchQuery.toLowerCase());

        const matchesCategory = !selectedCategory || item.category_name === selectedCategory;
        const matchesLocation = !selectedLocation || item.where_found === selectedLocation;
